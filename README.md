# copilot
App that get the device location using the cellular tower information (geolocation) and publish it as event in Particle Console (topic: googlemaps-data). This info would be sent to a PubSub in GCP.

- Device: Particle.io Electron
- Dependences: google-maps-device-locator.h (Google Maps Device Locator)
